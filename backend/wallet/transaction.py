...
class Transaction:
    ...
    def update(self, sender_wallet, recipient, amount):
        """
        Update the transaction with and existing or new recipient
        """
    ...
    def from_json(transaction_json):
        """
        Deserialize a transcation's json representation back into a
    ...
    def is_valid_transaction(transaction):
        ...
        Raise an exception for invalida transaction.
        """
